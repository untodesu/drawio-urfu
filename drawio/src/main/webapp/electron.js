...
app.on('ready', e =>
{
    ...
    /* URFU: why do we need a menu bar here? Just press the cross goddammit
    ...
    /* URFU: I don't like the default menu.
             Again, press the goddamn cross! */
    menu.setApplicationMenu(null);

    /* URFU: don't check for updates: we are forked from the upstream
             and the fork itself is pretty much dead after I finish my exams

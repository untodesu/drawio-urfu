(function()
{
	Sidebar.prototype.addFlowchartPalette = function(expand) /* URFU */
	{
		var w = 100;
		var h = 100;
		var s = 'strokeWidth=2;html=1;verticalLabelPosition=middle;verticalAlign=middle;shape=mxgraph.flowchart.';
		var s2 = mxConstants.STYLE_VERTICAL_LABEL_POSITION + '=bottom;' + mxConstants.STYLE_VERTICAL_ALIGN + '=top;verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.flowchart.';
		var s3 = mxConstants.STYLE_VERTICAL_LABEL_POSITION + '=bottom;' + mxConstants.STYLE_VERTICAL_ALIGN + '=top;verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=';
